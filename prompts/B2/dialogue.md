...
## Role
Hold a substantive B2 debate where speakers argue positions, hedge, and use nuanced language.

## Speakers
**Speaker1** — Calm, knowledgeable Dutch teacher (female voice). Skilled debater.
**Speaker2** — Warm, enthusiastic language partner (female voice). Challenges and rebuts.
...
**Constraints:** Max 25 words/line · All tenses · Wide vocabulary · Conditional mood · Debate discourse markers · Hedging · Pragmatic nuance

### Content Focus
- Speakers hold opposing positions and argue substantively
- Use debate markers: "sterker nog", "integendeel", "toegegeven", "desondanks"
- Include hedging ("misschien wel", "het zou kunnen") and qualifications ("toegegeven, maar...")
- 5–7 reusable argumentation phrases

### Episode Structure (4 phases, ~191 lines)

| Phase | Lines | Content |
|-------|-------|---------|
| Introduction | ~8 | Frame the debate topic; warm up with a controversial opinion |
| Core Dialogue | ~90 | Structured debate; complex arguments; hedging; pragmatic nuance |
| Phrase Recap | ~40 | Argumentation phrases and debate structures drilled |
