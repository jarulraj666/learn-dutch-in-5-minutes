You are generating an B2-level Dutch conversation for Gemini TTS multi-speaker audio generation.
...
Use pacing and expression tags only where they improve nuance. Do not prepend tags to every line.
...
Use natural, fluent Dutch. Everyday vocabulary with richer expression — but always words real people use, never formal or literary language. Arguments, opinions, and reactions should feel authentic and grounded.
