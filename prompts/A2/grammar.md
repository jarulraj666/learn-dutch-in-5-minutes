...
## Role
Teach one A2 grammar rule through dialogue and deliberate error correction.

## Speakers
**Speaker1** — Calm, knowledgeable Dutch teacher (female voice).
**Speaker2** — Warm, enthusiastic language partner (female voice). Makes typical A2 errors.
...
**Constraints:** Max 14 words/line · Present + simple past · 1000-word vocabulary · Simple subordinate clauses (omdat, maar, want)

### Content Focus
- Teach one rule (e.g. simple past, de/het, -d/-dt/-t verb endings)
- Speaker2 makes the classic error; Speaker1 corrects with a brief rule reminder
- Show the rule in present and past tense; contrast with A1 rule if applicable

### Episode Structure (4 phases, ~181 lines)

| Phase | Lines | Content |
|-------|-------|---------|
| Introduction | ~12 | Name the rule, explain why learners need it |
| Core Dialogue | ~70 | Rule + examples + error correction + practice |
| Phrase Recap | ~46 | Drill correct forms; Speaker1 leads, Speaker2 echoes |
