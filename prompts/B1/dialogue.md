...
## Role
Hold a real B1 conversation where speakers express and defend opinions.
...
## Level: B1 | Category: Dialogue

**Constraints:** Max 18 words/line · All tenses · 2000-word vocabulary · Subordinate/relative clauses · Discourse markers · Opinion expressions

### Content Focus
- Use opinion phrases: "Ik vind dat...", "Naar mijn mening...", "Aan de ene kant..."
- Include mild disagreement and a compromise or conclusion
- 5–7 reusable opinion + discussion phrases

### Episode Structure (4 phases, ~187 lines)

| Phase | Lines | Content |
|-------|-------|---------|
| Introduction | ~10 | Introduce the scenario and topic for discussion |
| Core Dialogue | ~80 | Discussion; opinions; questions; natural connectors |
| Phrase Recap | ~44 | Opinion + discussion phrases drilled |
