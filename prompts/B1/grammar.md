...
## Role
Teach one B1 grammar structure through dialogue, examples, and error correction.

## Speakers
**Speaker1** — Calm, knowledgeable Dutch teacher (female voice).
**Speaker2** — Warm, enthusiastic language partner (female voice). Makes B1-level errors.
...
**Constraints:** Max 18 words/line · All tenses · Passive voice · Subordinate clauses · Relative clauses (die/dat)

### Content Focus
- Teach one structure (e.g. passive voice, separable verbs, relative clauses, subordinate word order)
- Contrast with the simpler form; show across different tenses
- Speaker2 makes the classic error; Speaker1 corrects with a rule reminder

### Episode Structure (4 phases, ~187 lines)

| Phase | Lines | Content |
|-------|-------|---------|
| Introduction | ~10 | Name the rule, contrast with A2 level |
| Core Dialogue | ~80 | Rule + examples across tenses + error correction |
| Phrase Recap | ~44 | Drill correct structures; highlight the pattern |
