...
import db
import settings
from routers import admin, catalog, certificates, flashcards, health, me, progress, quiz
...
for module in (health, catalog, progress, quiz, flashcards, certificates, me, admin):
